...
function ConfirmDialog({open, title, children, onClose, onConfirm, onCloseText, onConfirmText}) {
  return (
              ...
              >
                <Dialog.Panel className="w-full max-w-md transform overflow-hidden rounded-2xl bg-white p-6 text-left align-middle shadow-xl transition-all">
                  ...
                  <div className="mt-4 space-x-2 text-center">
                    ...
                    {onConfirm && <button
                      type="button"
                      className="inline-flex justify-center rounded-md border border-transparent bg-blue-100 px-4 py-2 text-sm font-medium text-green-900 hover:bg-green-200 focus:outline-none"
                      onClick={onConfirm}
                    >
...
function AcknowledgeDialog({open, title, children, onClose}) {
    return (
        <Transition appear show={open} as={Fragment}>
            <Dialog as="div" className="relative z-10" onClose={onClose}>
              <Transition.Child
...
export { ConfirmDialog, AcknowledgeDialog }